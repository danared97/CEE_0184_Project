...
study_configs = [
    {"name": "Cali", "path": "....shp", "out_dir": "", "start": "", "end": ""},
    {"name": "Can", "path": "....shp", "out_dir": "", "start": "", "end": ""},
    {"name": "Kor", "path": "....shp", "out_dir": "",  "start": "", "end": ""},
    {"name": "Ind", "path": "....shp", "out_dir": "", "start": "", "end": ""},
    {"name": "Lib", "path": "....shp", "out_dir": "", "start": "", "end": ""},
]
...
#I already have my token and everything set up!
...
def download_and_save_daily(config):
    ...
    for i, date_val in enumerate(ds.time.values):
        # Convert numpy datetime64 to a clean string for the filename
        date_str = pd.to_datetime(date_val).strftime('%Y%m%d')
        filename = f"{config['name']}_{date_str}.tif"

        # Select the specific day and export
        daily_band = ds[var_name].isel(time=i)
        daily_band.rio.to_raster(filename)
